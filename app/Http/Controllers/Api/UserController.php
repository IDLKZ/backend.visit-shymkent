...
class UserController extends Controller
{
    ...
    {
        $savings = Saving::with(['blog', 'organizator.user', 'organizator.routes', 'souvenir', 'shop.souvenirs', 'route', 'place.category', 'event.workdays'])->where('user_id', auth('api')->id())->paginate(36);

                    ...
                    <div class="card-body">
                        <h6 class="card-title">
                            ...
                            @if($event->event_id)
                                ...
                                @endif
                                <small class="badge">
                                    С {{\Carbon\Carbon::parse(($event->eventumEvent->current_updated))->format("d/m/Y H:i:s")}}
                                </small>
                            @endif
                        </h6>
                        ...
                        <form id="event-form" class="forms-sample" method="post" enctype="multipart/form-data" action="{{route('events.update',$event->id)}}">
                            ...
                            <div class="form-group">
                                ...
                                <input id="address-map" type="text" class="form-control  @error('address') is-invalid @enderror" id="address" name='address' autocomplete="off" placeholder="{{__('admin.address')}}" value="{{$event->address}}">
                                @error('address')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>

                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center my-5">
                            ...
                            <a href="{{route('route_categories.create')}}" class="btn btn-success">
                                {{__("admin.create")}}
                                                ...
                                                <td class="d-flex">
                                                    <div class="btn-group dropdown">
                                                        ...
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="{{route("route_categories.show",$category->id)}}">{{__("admin.info")}}</a>
                                                            <a class="dropdown-item" href="{{route("route_categories.edit",$category->id)}}">{{__("admin.change")}}</a>
    ...
    <div class="modal fade" id="searchModal" tabindex="-1" role="dialog" aria-labelledby="searchModal" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="get" action="{{route("search-route-categories")}}" enctype="multipart/form-data">
                    @csrf
                    <div class="px-2">

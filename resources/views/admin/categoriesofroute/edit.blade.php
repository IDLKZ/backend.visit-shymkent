    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{__('admin.route_categories')}}</li>
            </ol>
        </nav>
            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="forms-sample" method="post" enctype="multipart/form-data" action="{{route('route_categories.update',$category->id)}}">
                            @csrf
                            @method("put")
                            ...
                            <a href="{{route("route_categories.index")}}" class="btn btn-light">{{__('admin.cancel')}}</a>
                        </form>
                    </div>
                </div>
            </div>
